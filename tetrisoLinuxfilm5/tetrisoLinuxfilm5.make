...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/tetrisoLinuxfilm5
OBJDIR = obj/x64/Debug/tetrisoLinuxfilm5
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/tetrisoLinuxfilm5
OBJDIR = obj/x86/Debug/tetrisoLinuxfilm5
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/tetrisoLinuxfilm5
OBJDIR = obj/ARM64/Debug/tetrisoLinuxfilm5
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGET = $(TARGETDIR)/tetrisoLinuxfilm5
OBJDIR = obj/x64/Release/tetrisoLinuxfilm5
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/tetrisoLinuxfilm5
OBJDIR = obj/x86/Release/tetrisoLinuxfilm5
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/tetrisoLinuxfilm5
OBJDIR = obj/ARM64/Release/tetrisoLinuxfilm5
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_GLFW_X11
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking tetrisoLinuxfilm5
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning tetrisoLinuxfilm5
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
...
$(OBJDIR)/main.o: src/main.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/posicion.o: src/posicion.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
